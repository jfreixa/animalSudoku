...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /home/jfreixa/projects/animalSudoku/src/main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Win = __webpack_require__(/*! ./states/Win */ 310);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tile = __webpack_require__(/*! ../sprites/Tile */ 307);

	var _Tile2 = _interopRequireDefault(_Tile);

	var _DraggableTile = __webpack_require__(/*! ../sprites/DraggableTile */ 308);

	var _DraggableTile2 = _interopRequireDefault(_DraggableTile);

	var _Trash = __webpack_require__(/*! ../sprites/Trash */ 309);
	...
	var Game = function (_Phaser$State) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function create() {
	      ...
	      this.tileSize = 180;
	      this.spaceBetween = 5;
	      this.sudokuProblem = [[0, 3, 1, 0], [2, 1, 3, 4], [0, 4, 0, 1], [1, 2, 0, 3]];
	      this.sudokuComplete = [[4, 3, 1, 2], [2, 1, 3, 4], [3, 4, 2, 1], [1, 2, 4, 3]];
	      // this.background = new Background({ game: this.game })

	      this.trash = new _Trash2.default({ game: this.game });

	      this.placeStaticTiles();
	      this.placeDraggableTiles();
	      this.draggablePositions.forEach(function (tile) {
	        _this2.draggableTiles.forEach(function (draggabletile) {
	          draggabletile.events.onDragStop.add(function (currentSprite) {
	            _this2.onStopDrag(currentSprite, tile);
	          }, _this2);
	        });
	        tile.events.onDragStop.add(function (currentSprite) {
	          _this2.game.physics.arcade.overlap(currentSprite, _this2.trash, function () {
	            return _this2.removeTile(tile);
	          });
	          currentSprite.goToOriginalPosition();
	          _this2.trash.close();
	        }, _this2);
	        tile.events.onDragStart.add(_this2.onDragStart, _this2);
	      });
	      this.draggableTiles.forEach(function (tile) {
	        tile.events.onDragStart.add(_this2.onDragStart, _this2);
	      });
	    }
	  }, {
	    key: 'placeStaticTiles',
	    value: function placeStaticTiles() {
	      var _this3 = this;

	      var numCols = this.sudokuProblem.length;
	      var numRows = this.sudokuProblem[0].length;
	      var leftSpace = (this.game.width - numCols * this.tileSize - (numCols - 1)) / 2;
	      var topSpace = (this.game.height - numRows * this.tileSize - (numRows - 1)) / 2;
	      this.draggablePositions = [];
	      this.actualSudoku = this.sudokuProblem.map(function (current, index1) {
	        return current.map(function (current, index2) {
	          var position = {
	            x: leftSpace + index1 * _this3.tileSize + _this3.spaceBetween * index1,
	            y: topSpace + index2 * _this3.tileSize + _this3.spaceBetween * index2
	          };
	          var sprite = void 0;
	          sprite = new _Tile2.default({
	            game: _this3.game,
	            x: position.x,
	            y: position.y,
	            tileSize: _this3.tileSize,
	            frame: current
	          });
	          if (current === 0) {
	            sprite = new _DraggableTile2.default({
	              game: _this3.game,
	              x: position.x,
	              y: position.y,
	              tileSize: _this3.tileSize,
	            ...
	            _this3.draggablePositions.push(sprite);
	          }
	          return sprite;
	        });
	      });
	    ...
	    key: 'placeDraggableTiles',
	    value: function placeDraggableTiles() {
	      var _this4 = this;
	      ...
	      var animals = [1, 2, 3, 4];
	      this.draggableTiles = [];
	      animals.map(function (number) {
	        _this4.draggableTiles.push(new _DraggableTile2.default({
	          game: _this4.game,
	          x: 50,
	          y: topSpace + (number - 1) * _this4.tileSize + _this4.spaceBetween * (number - 1),
	          tileSize: _this4.tileSize,
	          frame: number,
	          drag: true
	        }));
	      });
	    ...
	    key: 'onDragStart',
	    value: function onDragStart(currentSprite) {
	      currentSprite.bringToTop();
	      this.trash.open();
	    }
	  }, {
	    key: 'onStopDrag',
	    value: function onStopDrag(currentSprite, endSprite) {
	      var _this5 = this;

	      this.game.physics.arcade.overlap(currentSprite, endSprite, function () {
	        return _this5.changeSprite(currentSprite, endSprite);
	      });
	      currentSprite.goToOriginalPosition();
	      this.trash.close();
	    }
	    ...
	    key: 'changeSprite',
	    value: function changeSprite(currentSprite, endSprite) {
	    ...
	    value: function endGame() {
	      ...
	      if (this.isCompleted()) {
	        var actual = this.actualSudoku.map(function (line) {
	          return line.map(function (object) {
	            return object.frame;
	          });
	        }).join();
	        if (actual === this.sudokuComplete.join()) {
	          ...
	          this.actualSudoku.forEach(function (line, i) {
	            line.forEach(function (object, j) {
	              if (object.frame !== _this6.sudokuComplete[i][j]) {
	    ...
	    value: function isCompleted() {
	      return this.actualSudoku.every(function (line) {
	        return line.every(function (object) {
	    ...
	    key: 'removeTile',
	    value: function removeTile(currentSprite) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, 'tiles'));

	    _this.game = game;
	    _this.width = tileSize;
	    _this.height = tileSize;
	    _this.frame = frame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.input.enableDrag();
	    _this.input.draggable = drag;
	    _this.originalPosition = _this.position.clone();
	    return _this;
	  }

	  _createClass(_class, [{
	    key: 'goToOriginalPosition',
	    value: function goToOriginalPosition() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, game.width - 50, game.height + 50, 'basic', 'trashClose.png'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    key: 'create',
	    value: function create() {
	      var gameDone = this.add.button(0, 0, 'basic', this.newGame, this);
	      gameDone.frame = 1;
